...
namespace Nanolod.Calibration
{
    public class Selection
    {
        ...
        public static IEnumerable<SolutionType> RouletteWheel<SolutionType>(IEnumerable<SolutionType> Solutions,
        ...
        public static IEnumerable<SolutionType> RankBased<SolutionType>(IEnumerable<SolutionType> Solutions,
            IEnumerable<double> fitnesses, int selectCount = 1)
        {
            return RouletteWheel(Rank(Solutions, fitnesses), fitnesses, selectCount);
        }

        public static IEnumerable<SolutionType> RankBased<SolutionType>(IEnumerable<SolutionType> Solutions,
            Func<SolutionType, double> fitnessFunction, int selectCount = 1)
        {
            return RouletteWheel(Rank(Solutions, fitnessFunction), fitnessFunction, selectCount);
        }
        #endregion
