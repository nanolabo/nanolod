...
namespace Nanolod.Calibration.ABC
{
    public partial class Hive<FoodType, IBee> : IMetaHeuristic<FoodType>
    {
        ...
        private readonly int _failureLimit = 20;
        private readonly double _acceptProbability = 0.4; // the probability that an onlooker bee will accept a food source proposed by an employee bee
